...
def create_spacy_documents(nlp:spacy.language, data:List[Tuple[str, str]])->List[spacy.tokens.Doc]:
    """
...
def create_spacy_dataset(nlp, data:List[Tuple[str, str]], path:Union[Path, str])->None:
    """
